      ...
      <div className="flex gap-3 w-full ">
        ...
        <div className="border rounded bg-white pb-0.5 w-1/2">
          <div className="flex justify-between items-center px-3">
            <h6 className="py-3">Blend Order Details</h6>
            <IconButton
          ...
          <div className="mb-4 flex flex-col gap-[0.7rem]">
            ...
            <div className="flex">
              ...
              <Typography
                ...
                marginLeft={2}
                fontWeight="light">
                {orderDetailsData?.type === "blend"
                  ? orderDetailsData?.blendOrder?.quantity
                  : "-"}
              </Typography>
            </div>
          ...
          <div className="mb-4 flex flex-col gap-[0.7rem]">
            ...
            {/* <div className="flex">
              ...
              <Typography
                ...
                {" "}
                {orderDetailsData?.type === "blend"
                  ? orderDetailsData?.blendOrder?.kit?.kit_products?.name
                  : "-"}
              </Typography>
            </div> */}
            <div className="flex">
              ...
              <Typography
                ...
                {" "}
                {orderDetailsData?.type === "blend"
                  ? orderDetailsData?.blendOrder?.unit
                  : "-"}
              </Typography>
            </div>
          </div>
