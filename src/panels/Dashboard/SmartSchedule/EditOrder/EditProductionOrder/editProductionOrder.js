...
import { getInventoryListingApi } from "../../../../../api/inventoryApi";
...
const EditProductionOrder = () => {
  ...
  const getInventoryListing = () => {
    setInventoryLoading(true);
    getInventoryListingApi({
      order_id: id,
    })
      .then((res) => {
  ...
  return (
    <Box className="w-[100%]">
      ...
      {loadingDepend || commentLoading || loading || inventoryLoading ? (
        <Spinner />
      ) : (
        <>
