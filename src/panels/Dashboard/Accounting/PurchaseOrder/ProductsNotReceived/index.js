...
import {
  SearchBar,
  Spinner,
  Table as ProductsNotReceivedTable,
  ModalButton,
  OptionModal,
} from "../../../../../shared";
import { ManageProductNotReceived } from "../Components/utils";
import {
  columnData,
  editColumnDataForReceivedTable as editColumnData,
  tableColumnExtensionsForProductNotReceived as tableColumnExtensions,
  rowDataProductForNotReceived as rowDataProductNotReceived,
} from "../mockupData/mockupData";

const ProductsNotReceived = () => {
  ...
  const dataProviders = [
    {
      ...
      func: (resetProps) => ManageProductNotReceived(resetProps, setLoading),
    },
  ];
  ...
  return (
    <div className="main-container pl-4 ">
      ...
      {loading ? (
        ...
        <ProductsNotReceivedTable
          customer={true}
          rows={rowDataProductNotReceived}
...
export default ProductsNotReceived;
